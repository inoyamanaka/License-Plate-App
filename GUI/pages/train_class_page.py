...
class TrainLicensePlateApp:
    ...
    def tuning_parameter(self):
        ...
        self.button_next = tk.Button(self.content_frame, text='Next',
                                    ...
                                    data_path=f'{self.folder_selected}/data.yaml'))
    ...
    def result_preview_img(self):
        ...
        # Create an object of tkinter ImageTk
        self.img = Image.open("D:/python/license-plate-application/yolov5/runs/train/exp/confusion_matrix.png")
        self.img.thumbnail((300, 300))
        self.img = ImageTk.PhotoImage(self.img)

        # Create a Label Widget to display the text or Image
        self.label = tk.Label(self.content_frame, image = self.img, height=400, width=400, background="#1A1A1A")
        self.label.grid(row=1, column=0,pady=5)
        self.label.place(x=10, y=70)
        
        # Create an object of tkinter ImageTk result 2 
        self.img_2 = Image.open("D:/python/license-plate-application/yolov5/runs/train/exp/labels_correlogram.jpg")
        self.img_2.thumbnail((300, 300))
        self.img_2 = ImageTk.PhotoImage(self.img_2)

        # Create a Label Widget to display the text or Image
        self.label_2 = tk.Label(self.content_frame, image = self.img_2, height=400, width=400, background="#1A1A1A")
        self.label_2.grid(row=1, column=0,pady=5)
        self.label_2.place(x=10, y=400)
        
        # Create an object of tkinter ImageTk result 3
        self.img_3 = Image.open("D:/python/license-plate-application/yolov5/runs/train/exp/labels.jpg")
        self.img_3.thumbnail((300, 300))
        self.img_3 = ImageTk.PhotoImage(self.img_3)

        # Create a Label Widget to display the text or Image
        self.label_3 = tk.Label(self.content_frame, image = self.img_3, height=400, width=400, background="#1A1A1A")
        self.label_3.grid(row=0, column=1,pady=5, padx=5)
        self.label_3.place(x=450, y=70)
        
         # Create an object of tkinter ImageTk result 4
        self.img_4 = Image.open("D:/python/license-plate-application/yolov5/runs/train/exp/results.png")
        self.img_4.thumbnail((700, 300))
        self.img_4 = ImageTk.PhotoImage(self.img_4)

        # Create a Label Widget to display the text or Image
        self.label_4 = tk.Label(self.content_frame, image = self.img_4, height=400, width=800, background="#1A1A1A")
        self.label_4.grid(row=1, column=1,pady=5, padx=5)
        self.label_4.place(x=450, y=400)
